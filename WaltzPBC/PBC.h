...
//! Project version number for PBC.
FOUNDATION_EXPORT double PBCVersionNumber;

//! Project version string for PBC.
FOUNDATION_EXPORT const unsigned char PBCVersionString[];
